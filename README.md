...
I am a Staff Solutions Architect, based in Ottawa, Ontario, Canada. I have over 20 years of web development experience over various programming languages, having specialized in WordPress for the past 18 years. I work within the full-stack, including modern CSS (custom properties, PostCSS, CSS Grid), object-oriented PHP, and have a solid understanding of database and filesystem optimization and DevOps (specifically CI/CD).
...
- 🎵 I'm a musician - playing percussion and clarinet in two local community bands
- 📢 I have spoken at various WordCamps across North America (and globally, via Zoom) since 2016
- 🧑‍🤝‍🧑 I was Volunteer Team Lead (organizer) for WordCamp US in 2022 and 2023, and for WordCamp Canada in 2025 and 2026
